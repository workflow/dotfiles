...

{
  ...
  users.users.autoriza.openssh.authorizedKeys.keys = [
    ...
    "ecdsa-sha2-nistp256 AAAAE2VjZHNhLXNoYTItbmlzdHAyNTYAAAAIbmlzdHAyNTYAAABBBCHFgo4Lx21BFtPeclOmgqLINQCcrBza10R9LD8Er12mK22tH9IruDxOknA1gXMyJpP6LWB6mv10OyyhUqDlLeA= autoriza@nutyone"
  ];
