...

{
  ...
  users.users.autoriza.openssh.authorizedKeys.keys = [
    ...
    "ecdsa-sha2-nistp256 AAAAE2VjZHNhLXNoYTItbmlzdHAyNTYAAAAIbmlzdHAyNTYAAABBBMAIGa3kuY1sdrVkr9xcLbmkx4Lh0+O8nzaI+30qmJdYzt/AklCBS3+jH9a/ugz5kAXEFXIPQlAA0ix1ffTEQd4= autoriza@twentyone"
  ];
