  ...
  security.sudo.extraRules = [
    {
      ...
      commands = [
        {
          command = "${pkgs.auto-cpufreq}/bin/auto-cpufreq --force performance";
          options = ["NOPASSWD" "SETENV"];
        }
        {
          command = "${pkgs.auto-cpufreq}/bin/auto-cpufreq --force powersave";
          options = ["NOPASSWD" "SETENV"];
        }
        {
          command = "${pkgs.auto-cpufreq}/bin/auto-cpufreq --force reset";
          options = ["NOPASSWD" "SETENV"];
        }
        {
